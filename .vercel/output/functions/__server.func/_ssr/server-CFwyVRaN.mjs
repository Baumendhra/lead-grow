...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DYM1MUgT.mjs");
...
const manifest = {
  "c11ad9419d76ec33bb1ef02ec5110dda480ee7d0949bf7e06f0a58bca4cd4d06": {
    functionName: "searchPlaces_createServerFn_handler",
    importer: () => import("./leads.functions-D_p_E-q_.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-nQu_SNjE.mjs"),
    import("./start-DnhORcYz.mjs"),
